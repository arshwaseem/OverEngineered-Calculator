...
@SpringBootTest
public class SubtractorServiceIT {
    ...
    @Test
    void subtract_ShouldReturnCorrectSumGrpc() {

        OperationRequest operationRequest = OperationRequest.newBuilder().setNumA(9.0).setNumB(3.0).build();

        OperationResponse operationResponse = blockingStub.subtract(operationRequest);

        Assertions.assertEquals(6.0, operationResponse.getResult());
    }
